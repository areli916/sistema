...
<html>
    ...
    <body>
        ...
        %>
        <form action="SrvProcesosAlumnos?correoAnterior=<%=correo%>" method="post" name="frmAgregaralumno" id="frmAgregaralumno">     
            <table width="100%" border="0">
                ...
                <tr>
                    <td>MATRICULA</td>
                    <td>
                        <input readonly name="matricula" type="text" id="matricula" size="20" maxlength="10" 
                           <% if(matricula != null){ %>
                                value="<%=matricula%>"
                           <% } %>
                        >
                ...
                <tr>
                    <td>CORREO </td>
                    <td>
                        <input readonly name="correo" type="text" id="correo" size="50" maxlength="256"
                           <% if(correo != null){ %>
                                value="<%=correo%>"
                           <% } %>  
                        >
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><button type="submit" name="btnAlumnos" id="btnAlumnos" value="modificar">Modificar alumno</button></td>
                </tr>
                <% if(error!=null){ %>
                    <tr>
