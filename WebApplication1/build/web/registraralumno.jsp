...
-->
    ...
    <form action="SrvValidaRegistroAlumno" method="post" name="frmAgregaralumno" id="frmAgregaralumno">     
      <table width="100%" border="0">
        ...
        <tr>
          <td>MATRICULA</td>
          <td><input name="matricula" type="text" id="matricula" size="20" maxlength="10" 
                     <%
                     if(matricula != null){
                     %>
                     value="<%=matricula%>"
        ...
        <tr>
          <td>CORREO </td>
          <td><input name="correo" type="text" id="correo" size="0" maxlength="256"
                     <%
                     if(correo != null){
                     %>
                     value="<%=correo%>"
        ...
        <tr>
          ...
          <td><input name="fnacimiento" type="text" id="fnacimiento"  size="20" maxlength="10" placeholder="aaaa-mm-dd">
            <%
            if(fnacimiento!=null){
