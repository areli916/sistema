      ...
      <table width="100%" border="0">
        ...
        <% 
            ...
            if(request.getParameter("carrerasEncontradas") != null){
                carreras = misCarreras.buscarCarreras(request.getParameter("carrerasEncontradas"),"Activa");
            } else {
                carreras = misCarreras.consultarCarreras("activa");
            }
            String colorCelda = ""; 
            int i=0;
        ...
        <tr bgcolor="<%= colorCelda %>" > 
          ...
          <td>
              <a onClick="confirm('Seguro que desea eliminar este registro?') ? window.location.href='SrvProcesosCarreras?btnCarrera=eliminar&clave=<%= carrera.get("clave") %>' : alert('Error al eliminar')" title="eliminarCarrera" target="_self">
                  <img src="./imagenes/eliminar.png" alt="" width="90" height="60"/>
              </a>
          </td>
          <td>
              <a href="modificarcarrera.jsp?clave=<%=carrera.get("clave")%>&nombrecarrera=<%=carrera.get("nombrecarrera")%> "  target="_self">
                  <img src="./imagenes/modificar.png" alt="" width="90" height="60"/>              </a>          </td>
        </tr>
        <%  
            i++;
            }
